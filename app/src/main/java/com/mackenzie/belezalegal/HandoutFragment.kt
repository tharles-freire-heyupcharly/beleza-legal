...
import com.mackenzie.belezalegal.databinding.FragmentHandoutBinding
import java.io.File
 ...
 */
class HandoutFragment : Fragment() {
    private val viewModel: SharedViewModel by activityViewModels()
    private var _binding: FragmentHandoutBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHandoutBinding.inflate(inflater, container, false)
        return binding.root
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonNext.setOnClickListener {
            ...
            findNavController().navigate(R.id.action_handoutFragment_to_acknowledgementsFragment)
        }
    ...
    private fun downloadPdf(url: String) {
        ...
        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "cartilha.pdf")
