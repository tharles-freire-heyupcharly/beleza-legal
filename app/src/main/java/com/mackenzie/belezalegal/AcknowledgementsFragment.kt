...
import com.mackenzie.belezalegal.databinding.FragmentAcknowledgementsBinding
...
class AcknowledgementsFragment : Fragment() {
    ...
    private var _binding: FragmentAcknowledgementsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAcknowledgementsBinding.inflate(inflater, container, false)
        return binding.root
